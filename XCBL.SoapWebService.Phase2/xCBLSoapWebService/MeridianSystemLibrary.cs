...
namespace xCBLSoapWebService
{
    public static partial class MeridianSystemLibrary
    {
        ...
        #endregion Meridian SYST000XCBLService Database Methods
        ...
        public static string GetMeridian_Status(string status, string uniqueId, bool isShippingSchedule = true, bool isPastDate = false)
        {
            ...
            if (isPastDate)
                messageResponse.AppendLine(string.Format(MeridianGlobalConstants.MESSAGE_ACKNOWLEDGEMENT_COMMENT_OPEN_TAG 
                    + "{0}" + MeridianGlobalConstants.MESSAGE_ACKNOWLEDGEMENT_COMMENT_CLOSE_TAG, MeridianGlobalConstants.XCBL_RESPONSE_TYPE_CODED_SHIPPING_SCHEDULE_RESPONSE_ACCEPTED));
