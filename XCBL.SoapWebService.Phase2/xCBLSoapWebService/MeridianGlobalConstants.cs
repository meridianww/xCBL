...
namespace xCBLSoapWebService
{
	public class MeridianGlobalConstants
	{
		...
		#endregion xCBL General Constants
        ...
        **********************************************************************************************************************************************************************/
		...
		//ElectroluxResponse
		public const string MESSAGE_ACKNOWLEDGEMENT_NOTE_ELECTROLUX_OPEN_TAG = "<OrderResponse>";
		public const string MESSAGE_ACKNOWLEDGEMENT_NOTE_ELECTROLUX_CLOSE_TAG = "</OrderResponse>";
		...
		public const string MESSAGE_STATUSCODE_OPEN_TAG = "<statusCode>";
		public const string MESSAGE_STATUSCODE_CLOSE_TAG = "</statusCode>";

		/*********************************************************************************************************************************************************************/

		#endregion xCBL Message Acknowledgement Constants
        ...
        **********************************************************************************************************************************************************************/
		...
		#endregion xCBL Send Schedule Message Constants
